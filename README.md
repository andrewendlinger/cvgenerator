...
A tool to generate formatted, tailored PDF CVs from a simple text file. Stop manually editing `.tex` files for every job application and let this project automate the process for you.
